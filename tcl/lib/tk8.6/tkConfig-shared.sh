...
# installed.
TK_PREFIX='C:/xampp/htdocs/tcl'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='C:/xampp/htdocs/tcl'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-LC:/xampp/htdocs/tcl/lib -ltk86'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-LC:/xampp/htdocs/tcl/lib -ltkstub86'
...
TK_STUB_LIB_PATH='C:/xampp/htdocs/tcl/lib/tkstub86.lib'
=======
# tkConfig.sh --
# 
# This shell script (for sh) is generated automatically by Tk's
