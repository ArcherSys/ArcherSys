...
echo "</br>Initializing Database...";
 ...
 mysql_query("CREATE TABLE IF NOT EXISTS `users` ( `ID` mediumint(9) PRIMARY KEY NOT NULL AUTO_INCREMENT, `username` varchar(60) DEFAULT NULL,`password` varchar(60) DEFAULT NULL,`Role` enum('Admin','Guest','User','') NOT NULL, `Disabled` BOOLEAN NOT NULL ,`ProfilePicture` TEXT NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=latin1");
