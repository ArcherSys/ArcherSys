...
<form id="msform">
	<!-- progressbar -->
	<ul id="progressbar">
		<li class="active">OS Setup</li>
		<li>Security Services</li>
		<li>Personal Details</li>
	</ul>
	<!-- fieldsets -->
	<fieldset>
		<h2 class="fs-title">Setup your Database</h2>
		<h3 class="fs-subtitle">Database Configuration</h3>
		<input type="text" name="Host" placeholder="Database Host" />
				<input type="text" name="USer" placeholder="Database Username" />

		<input type="password" name="Passcode" placeholder="Database Password" />
		<input type="password" name="cpass" placeholder="Confirm Password" />
		<input type="button" name="next" class="next action-button" value="Next" />
	</fieldset>
	<fieldset>
		<h2 class="fs-title">Security Services</h2>
