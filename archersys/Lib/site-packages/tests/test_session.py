...
class TestClientUsage(unittest.TestCase):
    ...
    def test_build_url_params(self):
        ...
        self.assertEqual(base, 'https://api.dropbox.com/1/dropbox/metadata?' + urllib.parse.urlencode(params))
...
class TestSession(unittest.TestCase):
    ...
    def test_obtain_request_token(self):
        ...
        mock_response.read.return_value = urllib.parse.urlencode(new_request_token_res)
    ...
    def _obtain_access_token(self, call):
        ...
        mock_rest_client.POST.return_value = mock_response
        mock_response.read.return_value = urllib.parse.urlencode(new_access_token_res)
    ...
    def test_build_authorize_url(self):
        ...
        self.assertEqual('https://www.dropbox.com/1/oauth/authorize?' +
                         urllib.parse.urlencode({'oauth_token' : request_token.key,
    ...
    def test_parse_token_fail_empty(self):
        self._parse_token_fail(urllib.parse.urlencode({}))

    def test_parse_token_fail_no_oauth_token(self):
        self._parse_token_fail(urllib.parse.urlencode({'something': '1'}))

    def test_parse_token_fail_no_oauth_token_secret(self):
        self._parse_token_fail(urllib.parse.urlencode({'oauth_token': '1'}))
