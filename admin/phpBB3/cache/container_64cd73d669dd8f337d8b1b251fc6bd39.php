...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'pcgf.pmnamesuggestions.controller' => 'getPcgf_Pmnamesuggestions_ControllerService',
            'pcgf.pmnamesuggestions.listener' => 'getPcgf_Pmnamesuggestions_ListenerService',
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'abb_oauth_tokens', 'abb_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'abb_users', $this, './../', 'php');
    }
    ...
    {
        return $this->services['config'] = new \phpbb\config\db($this->get('dbal.conn'), $this->get('cache.driver'), 'abb_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text($this->get('dbal.conn'), 'abb_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), './../', 'php', 'abb_forums', 'abb_posts', 'abb_topics', 'abb_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('abb_captcha_questions', 'abb_captcha_answers', 'abb_qa_confirm');
    ...
    protected function getDbal_Conn_DriverService()
    {
        ...
        $instance->sql_connect('localhost', 'root', 'aco1234', 'acoserver_acoserver', '3306', false, false);
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('pcgf.pmnamesuggestions.listener', 'pcgf\\pmnamesuggestions\\event\\listener');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), $this->get('user'), 'abb_ext', './../', 'php', $this->get('cache.driver'));
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './../', 'adm/', 'php', 'abb_log');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'abb_migrations', './../', 'php', 'abb_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), './../', 'php', 'abb_modules');
    }
    ...
    {
        return new \phpbb\notification\type\admin_activate_user($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'abb_notification_types', 'abb_notifications', 'abb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\approve_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'abb_notification_types', 'abb_notifications', 'abb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\approve_topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'abb_notification_types', 'abb_notifications', 'abb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\bookmark($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'abb_notification_types', 'abb_notifications', 'abb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\disapprove_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'abb_notification_types', 'abb_notifications', 'abb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\disapprove_topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'abb_notification_types', 'abb_notifications', 'abb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\group_request($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'abb_notification_types', 'abb_notifications', 'abb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'abb_notification_types', 'abb_notifications', 'abb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\pm($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'abb_notification_types', 'abb_notifications', 'abb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'abb_notification_types', 'abb_notifications', 'abb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\post_in_queue($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'abb_notification_types', 'abb_notifications', 'abb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\quote($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'abb_notification_types', 'abb_notifications', 'abb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_pm($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'abb_notification_types', 'abb_notifications', 'abb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_pm_closed($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'abb_notification_types', 'abb_notifications', 'abb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'abb_notification_types', 'abb_notifications', 'abb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_post_closed($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'abb_notification_types', 'abb_notifications', 'abb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'abb_notification_types', 'abb_notifications', 'abb_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\topic_in_queue($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'abb_notification_types', 'abb_notifications', 'abb_user_notifications');
    }
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('user'), './../', 'php', 'abb_notification_types', 'abb_notifications', 'abb_user_notifications');
    }
    ...
    /**
     * Gets the 'pcgf.pmnamesuggestions.controller' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \pcgf\pmnamesuggestions\controller\controller A pcgf\pmnamesuggestions\controller\controller instance.
     */
    protected function getPcgf_Pmnamesuggestions_ControllerService()
    {
        return $this->services['pcgf.pmnamesuggestions.controller'] = new \pcgf\pmnamesuggestions\controller\controller($this->get('request'), $this->get('dbal.conn'), $this->get('auth'), $this->get('user'));
    }

    /**
     * Gets the 'pcgf.pmnamesuggestions.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \pcgf\pmnamesuggestions\event\listener A pcgf\pmnamesuggestions\event\listener instance.
     */
    protected function getPcgf_Pmnamesuggestions_ListenerService()
    {
        return $this->services['pcgf.pmnamesuggestions.listener'] = new \pcgf\pmnamesuggestions\event\listener($this->get('template'), $this->get('controller.helper'));
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper($this->get('dbal.conn'), 'abb_profile_fields_lang');
    }
    ...
    {
        return $this->services['profilefields.manager'] = new \phpbb\profilefields\manager($this->get('auth'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('request'), $this->get('template'), $this->get('profilefields.type_collection'), $this->get('user'), 'abb_profile_fields', 'abb_profile_lang', 'abb_profile_fields_data');
    }
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), './../', 'php', 'abb_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            'core.root_path' => './../',
            'core.php_ext' => 'php',
            'tables.auth_provider_oauth_token_storage' => 'abb_oauth_tokens',
            'tables.auth_provider_oauth_account_assoc' => 'abb_oauth_accounts',
            'tables.captcha_qa_questions' => 'abb_captcha_questions',
            'tables.captcha_qa_answers' => 'abb_captcha_answers',
            'tables.captcha_qa_confirm' => 'abb_qa_confirm',
            'tables.config' => 'abb_config',
            'tables.config_text' => 'abb_config_text',
            'tables.ext' => 'abb_ext',
            'tables.forums' => 'abb_forums',
            'tables.log' => 'abb_log',
            'tables.migrations' => 'abb_migrations',
            'tables.modules' => 'abb_modules',
            'tables.notification_types' => 'abb_notification_types',
            'tables.notifications' => 'abb_notifications',
            'tables.profile_fields' => 'abb_profile_fields',
            'tables.profile_fields_data' => 'abb_profile_fields_data',
            'tables.profile_fields_options_language' => 'abb_profile_fields_lang',
            'tables.profile_fields_language' => 'abb_profile_lang',
            'tables.posts' => 'abb_posts',
            'tables.topics' => 'abb_topics',
            'tables.user_notifications' => 'abb_user_notifications',
            'tables.users' => 'abb_users',
            ...
            'core.table_prefix' => 'abb_',
            'cache.driver.class' => 'phpbb\\cache\\driver\\file',
            'dbal.driver.class' => 'phpbb\\db\\driver\\mysqli',
            'dbal.dbhost' => 'localhost',
            'dbal.dbuser' => 'root',
            'dbal.dbpasswd' => 'aco1234',
            'dbal.dbname' => 'acoserver_acoserver',
            'dbal.dbport' => '3306',
            'dbal.new_link' => false,
        );
    }
