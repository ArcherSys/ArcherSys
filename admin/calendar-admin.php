...
<link rel="stylesheet" href="http://localhost/core/AdminLTE-2.3.7/bootstrap/css/bootstrap.min.css">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.5.0/css/font-awesome.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="http://localhost/core/AdminLTE-2.3.7/dist/css/AdminLTE.min.css">
  <!-- AdminLTE Skins. We have chosen the skin-blue for this starter
        page. However, you can choose any other skin. Make sure you
        apply the skin class to the body tag so the changes take effect.
  -->
  <link rel="stylesheet" href="http://localhost/core/AdminLTE-2.3.7/dist/css/skins/skin-blue.min.css">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo $_COOKIE["ProfilePicture_ARCHERVMCASHEW"]; ?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $_COOKIE["ID_ARCHERVMCASHEW"]; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  <?php echo $_COOKIE["ID_ARCHERVMCASHEW"]. " - ".$_COOKIE["Role_ARCHERVMCASHEW"]; ?>
...
<!-- jQuery 2.2.3 -->
<!-- jQuery 2.2.3 -->
<script src="http://localhost/core/js/jquery.js"></script>
<!-- Bootstrap 3.3.6 -->
<script src="https://code.jquery.com/ui/1.11.4/jquery-ui.min.js"></script>

<script src="http://localhost/core/AdminLTE-2.3.7/bootstrap/js/bootstrap.min.js"></script>
<!-- AdminLTE App -->
<script src="http://localhost/core/AdminLTE-2.3.7//plugins/fastclick/fastclick.js"></script>

<script src="http://localhost/core/AdminLTE-2.3.7/dist/js/app.min.js"></script>

<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js"></script>
<script src="http://localhost/core/AdminLTE-2.3.7/plugins/fullcalendar/fullcalendar.min.js"></script>
