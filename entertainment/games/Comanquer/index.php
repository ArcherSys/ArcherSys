...
<core-header-panel id="game-ui" flex>
  <core-toolbar>
      <div flex>Comanquer</div>
    </core-toolbar>
      <section id="game-ui"><paper-tabs selected="{{selected}}" link flex><paper-tab fl><a href="#info" horizontal center-center layout>FYI Comanquer</a></paper-tab><paper-tab ><a href="#game" horizontal center-center layout>Play</a></paper-tab></paper-tabs>
<core-pages selected="{{selected}}">
  <div id="info"><img style="float:left;"src="images/logo.jpg" width="400" height="146" alt="Command and Conquer">
