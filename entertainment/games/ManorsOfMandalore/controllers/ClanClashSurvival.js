app.controller("ClanClashSurvival", function($scope, $timeout, $interval) {
...

{
  ...
  $scope.updateState = function() {
    ...
    if (!someFamilyIsAlive) {
      $scope.pause();
      $scope.end("Welp, there goes the last of your clan, you survived " + $scope.family.day + " days on Mandalore.");
    }
  }
  $scope.assassins = [{
