        <link rel="stylesheet" href="http://cdn3.recombu.com/min/mobile/1.52/css/interactive/iphone5s.css" type="text/css" media="screen" />
        <link rel="stylesheet" href="http://cdn3.recombu.com/min/mobile/1.54/css/interactive/recombu.css" type="text/css" media="screen" />
        <link href='http://fonts.googleapis.com/css?family=Mate|Open+Sans:400,600|Merriweather+Sans:700' rel='stylesheet' type='text/css'>
        <style type="text/css">
            body { background: none; text-align: center; }
            
            #colour { width: 400px; margin: 0 auto 25px; float: none; }
        </style>
<script>
    $(".next").click(function(){
       $("iframe.browser").attr("src",$("#address-bar").val());
    });
</script>
    ...
    <div id="iPhone" class="off">
        ...
        <div class="inner-1"><div class="inner-2">
                <div class="screen"><div class="screen-inner">
                        <div id="pull-down">
                            ...
                            <ul class="notifications">
                                <li class="heading"><i class="icon phone"><span class="gradient"></span><b></b></i>Phone<b class="close">&times;</b></li>
                                <li id="phone-app"><span class="indicator"></span>Blocked<span class="small">Missed Call</span><em>14:08</em></li>
                                <li class="heading"><i class="icon messages"><span class="gradient"></span><b></b></i>Messages<b class="close">&times;</b></li>
                                <li id="messages-app"><span class="indicator"></span>Tofu<span class="small">Did you know that this iPhone 5S concept has been built using only HTML, CSS &amp; JavaScript, without a single image?</span><em>2h ago</em></li>
                            </ul>
                        </div>
                        ...
                        <div id="messages" class="app">
                            ...
                            <div class="ctr">
                                <ul class="msgs">
                                    <li><p>My mobile contract is ending soon, quite fancy the new iPhone too.</p><p class="date"><span>Read</span> 24 May 2013 14:21</p></li>
                                    <li><i class="icon"><span class="green"></span><span class="orange"></span><span class="grey"></span><span class="bg">r</span></i><p>Good choice! It's a great phone.</p><p class="date"><span>Read</span> 24 May 2013 14:21</p></li>
                                    <li><p>I like this demo!</p><p class="date"><span>Read</span> 24 May 2013 14:21</p></li>
                                    <li><i class="icon"><span class="green"></span><span class="orange"></span><span class="grey"></span><span class="bg">r</span></i><p>Yeah, it's very cool!</p><p class="date"><span>Read</span> 24 May 2013 14:29</p></li>
                                    <li><p>Yesssssssssssss!</p><p class="date"><span>Read</span> 24 May 2013 14:37</p></li>
                                    <li><i class="icon"><span class="green"></span><span class="orange"></span><span class="grey"></span><span class="bg">r</span></i><p>Did you know that this iPhone 5S concept has been built using only HTML, CSS &amp; JavaScript, without a single image?</p><p class="date"><span>Read</span> 24 May 2013 14:39</p></li>
                                </ul>
                        ...
                        <div id="mail" class="app">
                            ...
                            <ul>
                                <li><b></b><i></i><h3>Tofu</h3><h4>Interactive Apple iPhone 5S & iOS 7 Concept</h4><p class="date">Today</p><p>Do you like this demo?</p></li>
                                <li><i></i><h3>Apple</h3><h4>iPad. There's just so much to love about it.</h4><p class="date">Yesterday</p><p>When iPad was introduced, there was nothing quite like it. And there still isn't. Today...</p></li>
                            </ul>
                            <div class="bottom-bar">
                        ...
                        <div id="safari" class="app">
                            <div class="top-bar">
                                <span class="title">Interactive Apple iPhone 5S & iOS 7 Concept</span>
                                <input type="text" id="address-bar" placeholder="Search or type URL" /><span class="reload"></span>
                            </div>
                            <iframe src="http://codepen.io/Tofu/pen/dtobw" width="312" height="534" scrolling="yes"></iframe>
                            <div class="bottom-bar">
                                <ul>
                        ...
                        <div id="music" class="app">
                            <div class="top-bar">
                                Trendy Spots<br />
                                <span class="title">Trendy Spots</span><br />

The Green Playlist                                <b>Back</b>
                            ...
                            <div class="album-cover"><iframe src="https://embed.spotify.com/?uri=spotify:user:wh170:playlist:0zpD6Ko8LyOqLQq0HbKrLt" width="300" height="380" frameborder="0" allowtransparency="true"></iframe><b></b></div>
                            <div class="controls">
                                <i class="play"></i>
                        ...
                        <div id="phone" class="app">
                            ...
                            <div class="bottom-bar">
                                <ul>
                                    ...
                                    <li class="active"><div class="keypad"><ul><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li></ul></div>Keypad</li>
                        ...
                        <div id="notes" class="app">
                            ...
                            <textarea>iPhone 5S and iOS7 concept with no images.</textarea>
                            <div class="bottom-bar">
                                <ul>
                        ...
                        <div id="camera" class="app">
                            ...
                            <div class="bg"><span>Please enable your webcam to use the camera app.<br /><br />(This feature will currently only work in Firefox or Chrome)</span></div>
                        </div>
                        ...
                        <div class="lock-screen wallpaper">
                            ...
                            <div class="time-date">
                                <div class="time"><span id="hour2"></span>:<span id="minute2"></span></div>
                                <span id="date"></span>
                                <ul class="widgets">
                                    <li class="wifi off"><i class="wifi"><span class="overlay"></span><b></b><em></em></i><label>Wi-Fi</label></li>
                                    <li class="bluetooth off"><i class="bluetooth"><em></em></i><label>Bluetooth</label></li>
                            ...
                            <div class="slide-wrap"><div id="slider"><div id="slider-handle"></div></div></div>
                        ...
                        <div class="home-screen wallpaper">
                            <div class="notification messages">
                                ...
                                <h2>Messages</h2>
                                <p>Did you know that this iPhone 5S concept has been built using only HTML, CSS &amp; JavaScript, without a single image?</p>
                            ...
                            <div class="apps">
                                ...
                                <a href="" target="_blank" class="icon facebook"><span class="name">Facebook</span></a>
                                <a href="" target="_blank" class="icon twitter"><span class="ctr"><b class="c1"></b><b class="c2"></b><b class="c3"></b><b class="c4"></b><b class="c5"></b><b class="beak"></b></span><span class="name">Twitter</span></a>
                                <a href="" class="icon google-plus-icon"><span class="gradient"></span><b>g</b><em>+</em><span class="name">Google+</span></a>
                            </div>
                            <div class="apps dock">
                        ...
                        <div class="volume-overlay">
                            ...
                            <ul><li class="on"></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li></ul>
                        </div>
                    </div></div>
            </div></div>
    </div>
    ...
    <ul id="colours">
        <li class="select">Select color:</li>
        ...
        <li><a href="#" class="pink">Pink</a></li>
        <li><a href="#" class="gold">Gold</a></li>
    </ul>
</div>

<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js" type="text/javascript"></script>
<script src="http://cdn2.recombu.com/min/mobile/1.0/lib/interactive/iphone5s.js"></script>
<script src="http://cdn2.recombu.com/min/mobile/2.38/lib/interactive/jquery-ui.js"></script>
<script src="http://cdn2.recombu.com/mobile/2.38/lib/interactive/jquery.ui.touch-punch.min.js"></script>
<script src="http://cdn2.recombu.com/mobile/2.38/lib/lazyload-min.js"></script>
        
        <script type="text/javascript">
        var _gaq = _gaq || [];
        _gaq.push(["_setAccount", "UA-8453255-1"]);
        _gaq.push(["_trackPageview"]);
        setTimeout("_gaq.push(['_trackEvent', 'Page', 'Read', '20 seconds'])", 20000);
    ...
    <script type="text/javascript">if(!NREUMQ.f){NREUMQ.f=function(){NREUMQ.push(["load",new Date().getTime()]);var e=document.createElement("script");e.type="text/javascript";e.src=(("http:"===document.location.protocol)?"http:":"https:")+"//"+"d1ros97qkrwjf5.cloudfront.net/42/eum/rum.js";document.body.appendChild(e);if(NREUMQ.a)NREUMQ.a();};NREUMQ.a=window.onload;window.onload=NREUMQ.f;};NREUMQ.push(["nrfj","beacon-3.newrelic.com","6a396452d8","1050722","MwRbZENTW0tRAUFbVgpObEJYHVxWVAdNHEkMEQ==",0,68,new Date().getTime(),"","","","",""]);</script>