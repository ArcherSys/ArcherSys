...
import Jawa.src.archersysos.jawa.io.*;
public class Game 
{
  ...
  private final int HAND_SIZE = 5;
	...
	public void play()
	{
		...
		JawaIO.Print("Thanks for playing! =]");
	}
	...
	public Card[] redraw()
	{
		...
		{
			JawaIO.Print("Redraw card " + (counter + 1) + "?" +
					" (1 for yes, 0 for no)");
	...
	public void evaluate()
	{
		...
		{
			JawaIO.Print("You have a royal flush!");
		}
		else if (this.straightFlush() == 1)
		{
			JawaIO.Print("You have a straight flush!");
		}
		else if (this.fourOfaKind() == 1)
		{
			JawaIO.Print("You have four of a kind!");
		}
		else if (this.fullHouse() == 1)
		{
			JawaIO.Print("You have a full house!");
		}
		else if (this.flush() == 1)
		{
			JawaIO.Print("You have a flush!");
		}
		else if (this.straight() == 1)
		{
			JawaIO.Print("You have a straight!");
		}
		else if (this.triple() == 1)
		{
			JawaIO.Print("You have a triple!");
		}
		else if (this.twoPairs() == 1)
		{
			JawaIO.Print("You have two pairs!");
		}
		else if (this.pair() == 1)
		{
			JawaIO.Print("You have a pair!");
		}
		else
		{
			int highCard = this.highCard();
			JawaIO.Print("Your highest card is " + highCard);
		}
	}
