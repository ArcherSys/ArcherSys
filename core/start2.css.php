<?php
  require_once $_SERVER["DOCUMENT_ROOT"]."/includes/CSS.php";
  use ArcherSys\Csytlus\CSS
  CSS::defineStylesheet();
?>
...
margin-top: 30px; /* outside Codepen is actually 30px */
}
...
.gallery{
	background: url(/core/media/img/logo.png);
