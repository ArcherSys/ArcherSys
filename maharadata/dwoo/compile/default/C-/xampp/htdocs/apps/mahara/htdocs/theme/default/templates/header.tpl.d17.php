...
?>
  <?php if ((is_string($tmp=(isset($this->scope["SUBPAGETOP"]) ? $this->scope["SUBPAGETOP"] : null)) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp)) {

echo Dwoo_Plugin_include($this, (is_string($tmp=(isset($this->scope["SUBPAGETOP"]) ? $this->scope["SUBPAGETOP"] : null)) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp), null, null, null, '_root', null);
...
<?php 
$_fh1_data = (is_string($tmp=(isset($this->scope["SUBPAGENAV"]) ? $this->scope["SUBPAGENAV"] : null)) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp);
