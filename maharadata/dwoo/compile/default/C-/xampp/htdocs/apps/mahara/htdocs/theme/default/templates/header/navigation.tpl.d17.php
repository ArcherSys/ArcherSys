...
?>adminnav <?php 
            ...
            <h3 class="rd-nav-title"><a href="#"><?php if ((is_string($tmp=(isset($this->scope["ADMIN"]) ? $this->scope["ADMIN"] : null)) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp) || (is_string($tmp=(isset($this->scope["INSTITUTIONALADMIN"]) ? $this->scope["INSTITUTIONALADMIN"] : null)) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp) || (is_string($tmp=(isset($this->scope["STAFF"]) ? $this->scope["STAFF"] : null)) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp) || (is_string($tmp=(isset($this->scope["INSTITUTIONALSTAFF"]) ? $this->scope["INSTITUTIONALSTAFF"] : null)) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp)) {

echo Dwoo_Plugin_str($this, 'admin', 'mahara', null, null, null, null, null);?> <?php 
}
echo Dwoo_Plugin_str($this, 'menu', 'mahara', null, null, null, null, null);?><span class="rd-arrow"></span></a></h3>
...
<?php $_fh8_data = (is_string($tmp=(isset($this->scope["MAINNAV"]) ? $this->scope["MAINNAV"] : null)) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp);if ($this->isArray($_fh8_data) === true){foreach ($_fh8_data as $this->scope['item']){/* -- foreach start output */?><li class="<?php if ((is_string($tmp=(isset($this->scope["item"]["path"]) ? $this->scope["item"]["path"]:null)) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp)) {
...
?>
            <ul><?php $_fh9_data = (is_string($tmp=(isset($this->scope["SELECTEDSUBNAV"]) ? $this->scope["SELECTEDSUBNAV"] : null)) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp);if ($this->isArray($_fh9_data) === true){foreach ($_fh9_data as $this->scope['item']){/* -- foreach start output */?><li<?php if ((is_string($tmp=(isset($this->scope["item"]["selected"]) ? $this->scope["item"]["selected"]:null)) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp)) {?> class="selected"<?php }?>><span><a href="<?php echo (is_string($tmp=$this->scope["WWWROOT"]) ? htmlspecialchars($tmp, ENT_QUOTES, $this->charset) : $tmp);
