...
<head>
<title>ArcherSys OS Mobile</title>
...
$(function(){
   ...
   $(document).on("pageinit","#os-home",function(){
       console.info
       $(document).on("swipeleft swiperight","#applist li",function(event){
           console.log("Swipe Detected");
           console.log(event);
           window.location.assign($(event.target).attr("href"));
       })
   });
  $("#theme").addClass("ui-page-theme-" +localStorage.getItem("theme"));
...
<p id="orientation">orientationchange Not Supported on this Device.</p>
     <form class="ui-filterable">
      <input id="homeSearch" data-type="search" mozactionhint="search" placeholder="Search Everything">
 </form>
   <ul id="applist" data-role="listview" data-filter="true" data-input="#homeSearch">
     <li data-role="listdivider">Apps</li>
   <li><a id="PDFL6ME" href="http://localhost:80/Producktiviti/PDFLint/index-mobile.php">PDFLint 6 for Mobile</a></li>
...
<button id="start-togetherjs" type="button"
 ...
 <div data-role="page" id="template1">
